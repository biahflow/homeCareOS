/**
 * Casca das telas de acesso (login e segundo fator): split com o painel de
 * marca à esquerda e o formulário à direita.
 *
 * Existe como componente — e não copiada em cada tela — porque duas cópias do
 * mesmo gradiente divergem no primeiro ajuste. A marcação aqui é exatamente a
 * que a tela de login já tinha; nada do visual mudou ao ganhar um segundo
 * inquilino.
 *
 * Não tem `"use client"`: é markup estático, e o que precisa de estado é o
 * formulário que entra em `children`.
 */
